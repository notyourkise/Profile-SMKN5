        ...
        <div class="max-w-4xl mx-auto">
            ...
            <nav class="mb-8">
                <ol class="flex space-x-2 text-gray-600 dark:text-gray-400">
                    ...
                    <li>/</li>
                    <li><a href="{{ route('jurusan.index') }}" class="hover:text-primary dark:hover:text-secondary">Jurusan</a></li>
                    <li>/</li>
                    <li class="text-primary dark:text-secondary">{{ $jurusan->nama }}</li>
                </ol>
            </nav>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden mb-8">
                ...
                @else
                <div class="w-full h-96 bg-primary/10 dark:bg-gray-700 flex items-center justify-center">
                    <span class="text-9xl text-primary dark:text-secondary font-bold">{{ $jurusan->kode }}</span>
                </div>
                @endif
                
                <div class="p-8">
                    <div class="flex items-center space-x-4 mb-4">
                        <span class="bg-primary dark:bg-primary text-white px-4 py-2 rounded font-bold text-lg">{{ $jurusan->kode }}</span>
