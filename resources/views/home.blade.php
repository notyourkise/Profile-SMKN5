...
@section('content')
<!-- Hero Section -->
<section class="bg-gradient-to-r from-blue-600 to-blue-800 dark:from-gray-800 dark:to-gray-900 text-white py-20 transition-colors duration-200">
    <div class="container mx-auto px-4 text-center">
        <h1 class="text-5xl font-bold mb-4">Selamat Datang di SMKN 5 Samarinda</h1>
        <p class="text-xl mb-8">Membangun Generasi Unggul dan Berkarakter</p>
        <a href="{{ route('jurusan.index') }}" class="bg-white text-blue-600 dark:bg-gray-700 dark:text-white px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 dark:hover:bg-gray-600 transition">
            Lihat Jurusan
        </a>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition">
                ...
                <div class="w-full h-48 bg-blue-100 dark:bg-blue-900 flex items-center justify-center">
                    <span class="text-4xl text-blue-600 dark:text-blue-400">{{ $item->kode }}</span>
                </div>
                @endif
                <div class="p-6">
                    ...
                    <a href="{{ route('jurusan.show', $item->id) }}" class="text-blue-600 dark:text-blue-400 font-semibold hover:text-blue-800 dark:hover:text-blue-300">
                        Selengkapnya &rarr;
                    </a>
                </div>
            </div>
...
<section class="py-16 bg-gray-100 dark:bg-gray-800 transition-colors duration-200">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white dark:bg-gray-700 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition">
                ...
                <div class="p-6">
                    ...
                    <a href="{{ route('berita.show', $berita->slug) }}" class="text-blue-600 dark:text-blue-400 font-semibold hover:text-blue-800 dark:hover:text-blue-300">
        ...
        <div class="text-center mt-8">
            <a href="{{ route('berita.index') }}" class="bg-blue-600 dark:bg-blue-700 text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-700 dark:hover:bg-blue-600 transition">
                Lihat Semua Berita
            </a>
        </div>
        @endif
